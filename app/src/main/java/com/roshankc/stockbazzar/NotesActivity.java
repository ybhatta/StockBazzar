...
public class NotesActivity extends AppCompatActivity {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.menu_home:{
                        Intent intent= new Intent(NotesActivity.this,LoggedInPage.class);
                    ...
                    case R.id.menu_stock_portfolio:{
                        Intent intent= new Intent(NotesActivity.this,PortfolioActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
                        finish();
                        break;
                    ...
                    case R.id.menu_watchlist:{
                        Intent intent= new Intent(NotesActivity.this,WatchListActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
                        finish();
                        break;
                ...
                JsonObjectRequest request= new JsonObjectRequest(Request.Method.GET, URL,null,new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try{
                            ...
                            Intent intent= new Intent(NotesActivity.this,SearchActivity.class);
                            intent.putExtra("user",user);
    ...
    private void setUpViews(){
        searchView=findViewById(R.id.sv_searchNA);
    }
