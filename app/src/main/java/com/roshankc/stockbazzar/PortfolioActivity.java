...
public class PortfolioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.menu_home:{
                        Intent intent= new Intent(PortfolioActivity.this,LoggedInPage.class);
                    ...
                    case R.id.menu_notes:{
                        Intent intent= new Intent(PortfolioActivity.this,NotesActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
                        finish();
                        break;
                    ...
                    case R.id.menu_watchlist:{
                        Intent intent= new Intent(PortfolioActivity.this,WatchListActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
                        finish();
                        break;
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                RequestQueue queue= Volley.newRequestQueue(PortfolioActivity.this);
                queue.add(request);
                return false;
            }
    ...
    private void setUpViews(){
        searchView= findViewById(R.id.sv_searchPoA);
    }
