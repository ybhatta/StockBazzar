...
public class SellTransactionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_sell);

        setUpViews();
        user= (User) getIntent().getSerializableExtra("user");
        stockDetails=(StockDetails)getIntent().getSerializableExtra("stockDetails");

        tvResponse.setText("Sell "+stockDetails.getCompanyName());
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.menu_home:{
                        Intent intent= new Intent(SellTransactionActivity.this,LoggedInPage.class);
                    ...
                    case R.id.menu_notes:{
                        Intent intent= new Intent(SellTransactionActivity.this,NotesActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
                        break;
                    }
                    ...
                    case R.id.menu_stock_portfolio:{
                        Intent intent= new Intent(SellTransactionActivity.this,PortfolioActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
                        break;
                    }
                    case R.id.menu_watchlist:{
                        Intent intent= new Intent(SellTransactionActivity.this,WatchListActivity.class);
                        intent.putExtra("user",user);
                        startActivity(intent);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                JsonObjectRequest request= new JsonObjectRequest(Request.Method.GET, URL,null,new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try{
                            ...
                            Intent intent= new Intent(SellTransactionActivity.this,SearchActivity.class);
                            intent.putExtra("user",user);
                ...
                RequestQueue queue= Volley.newRequestQueue(SellTransactionActivity.this);
                queue.add(request);
                return false;
            }
